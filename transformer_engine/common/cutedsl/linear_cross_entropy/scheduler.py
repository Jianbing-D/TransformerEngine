...
class StaticPersistentScheduler:
    ...
    class Params(ParamsBase):
        num_tiles_M_divmod: FastDivmodDivisor
        total_blocks: Int32
        ...
        def create(
            ...
            *,
            ...
            total_blocks = args.num_tiles_M * args.num_tiles_N
            return StaticPersistentScheduler.Params(
                FastDivmodDivisor(args.num_tiles_N),
                total_blocks
            )
    ...
    def get_current_work(self, *, loc=None, ip=None) -> WorkTileInfo:
        ...
        return WorkTileInfo(
            (Int32(m_idx), Int32(n_idx)), is_valid
        )
...
if __name__ == "__main__":
    class TestScheduler:
        ...
        def __call__(self):
            ...
            grid_dim = self.scheduler_cls.get_grid_shape(params, sm_count=1)
        ...
        def kernel(
            ...
            if warp_idx == 0:
                ...
                while work_tile.is_valid_tile:
                    m_block, n_block = work_tile.tile_idx

                    if lane_idx == 0:
                        cute.printf("block_idx: {}, warp_idx: {}, m_block: {}, n_block: {}", 
                                    bidx, warp_idx, m_block, n_block)
